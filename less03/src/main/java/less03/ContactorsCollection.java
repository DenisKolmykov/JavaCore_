...
Последняя подзадача действительно хитрая, она скорее на понимание работы интерфейса Iterable,
когда мы можем наделить свой собственный объект свойством быть перечисляемым:
...
Таким образом, мы можем работать с перебором коллекции не напрямую,
в качестве источника перечисления выступает наш собственный объект:
